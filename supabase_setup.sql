-- Execute no SQL Editor do projeto Cyber Detective:
...
create policy "Players can view own profile" on public.player_profiles
...
create trigger on_auth_user_created_player after insert on auth.users
